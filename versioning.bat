...
dotnet script ./GradientSoftware.GithubScripts/.github/scripts/update-version.csx %GITHUB_USERNAME% GradientSoftware.GoogleWorksheetToCalendar %GITHUB_APIKEY% ./GoogleWorksheetToCalendar/GoogleWorksheetToCalendar.csproj %branch%
